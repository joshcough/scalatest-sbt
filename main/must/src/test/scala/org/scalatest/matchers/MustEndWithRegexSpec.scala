...
class MustEndWithRegexSpec extends Spec with MustMatchers with Checkers with ReturnsNormallyThrowsAssertion {
...
*/
  ...
  describe("The endWith regex syntax") {
    ...
    describe("(when the regex is specified by a string)") {
      ...
      it("must do nothing if the string ends with substring that matched the regular expression specified as a string") {

        "1.78" must endWith regex (".78")
        "1.7" must endWith regex (decimal)
        "21.7" must endWith regex (decimal)
        "1.78" must endWith regex (decimal)
        "x8" must endWith regex (decimal)
        "x1." must endWith regex (decimal)

        // The remaining are full matches, which must also work with "endWith"
        "1.7" must endWith regex ("1.7")
        "1.7" must endWith regex (decimal)
        "-1.8" must endWith regex (decimal)
        "8" must endWith regex (decimal)
        "1." must endWith regex (decimal)
      }
  
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used with not") {

        "eight" must not { endWith regex (decimal) }
        "one.eight" must not { endWith regex (decimal) }

        "eight" must not endWith regex (decimal)
        "one.eight" must not endWith regex (decimal)
      }
  
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used in a logical-and expression") {

        "b1.7" must (endWith regex (decimal) and (endWith regex (decimal)))
        "b1.7" must ((endWith regex (decimal)) and (endWith regex (decimal)))
        "b1.7" must (endWith regex (decimal) and endWith regex (decimal))

        "1.7" must (endWith regex (decimal) and (endWith regex (decimal)))
        "1.7" must ((endWith regex (decimal)) and (endWith regex (decimal)))
        "1.7" must (endWith regex (decimal) and endWith regex (decimal))
      }
  
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used in a logical-or expression") {

        "b1.7" must (endWith regex ("hello") or (endWith regex (decimal)))
        "b1.7" must ((endWith regex ("hello")) or (endWith regex (decimal)))
        "b1.7" must (endWith regex ("hello") or endWith regex (decimal))
  
        "1.7" must (endWith regex ("hello") or (endWith regex (decimal)))
        "1.7" must ((endWith regex ("hello")) or (endWith regex (decimal)))
        "1.7" must (endWith regex ("hello") or endWith regex (decimal))
      }
  
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used in a logical-and expression with not") {
        "fred" must (not (endWith regex ("bob")) and not (endWith regex (decimal)))
        "fred" must ((not endWith regex ("bob")) and (not endWith regex (decimal)))
        "fred" must (not endWith regex ("bob") and not endWith regex (decimal))
      }
  
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used in a logical-or expression with not") {
        "fred" must (not (endWith regex ("fred")) or not (endWith regex (decimal)))
        "fred" must ((not endWith regex ("fred")) or (not endWith regex (decimal)))
        "fred" must (not endWith regex ("fred") or not endWith regex (decimal))
      }
      ...
      it("must throw TestFailedException if the string does matches substring that matched the regular expression specified as a string when used with not") {
        ...
        val caught21 = intercept[TestFailedException] {
          "a1.7" must not { endWith regex ("1.7") }
        }
        ...
        val caught22 = intercept[TestFailedException] {
          "b1.7" must not { endWith regex (decimal) }
        }
        ...
        val caught23 = intercept[TestFailedException] {
          "b-1.8" must not { endWith regex (decimal) }
        }
        assert(caught23.getMessage === "\"b-1.8\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
      }

      it("must throw TestFailedException if the string ends with substring that matched the regular expression specified as a string when used in a logical-and expression") {
  
        val caught1 = intercept[TestFailedException] {
          "1.7" must (endWith regex (decimal) and (endWith regex ("1.8")))
        }
        ...
        val caught4 = intercept[TestFailedException] {
          "1.eight" must (endWith regex (decimal) and (endWith regex ("1.8")))
        }
      ...
      it("must throw TestFailedException if the string ends with substring that matched the regular expression specified as a string when used in a logical-or expression") {
  
        val caught1 = intercept[TestFailedException] {
          "1.seven" must (endWith regex (decimal) or (endWith regex ("1.8")))
        }
      ...
      it("must throw TestFailedException if the string ends with substring that matched the regular expression specified as a string when used in a logical-and expression used with not") {

        val caught1 = intercept[TestFailedException] {
          "1.7" must (not endWith regex ("1.8") and (not endWith regex (decimal)))
        }
        ...
        val caught4 = intercept[TestFailedException] {
          "a1.7" must (not endWith regex ("1.8") and (not endWith regex (decimal)))
        }
      ...
      it("must throw TestFailedException if the string ends with substring that matched the regular expression specified as a string when used in a logical-or expression used with not") {
  
        val caught1 = intercept[TestFailedException] {
          "1.7" must (not endWith regex (decimal) or (not endWith regex ("1.7")))
        }
        ...
        val caught5 = intercept[TestFailedException] {
          "a1.7" must (not endWith regex (decimal) or (not endWith regex ("1.7")))
        }
    ...
    describe("(when the regex is specified by an actual Regex)") {
      ...
      it("must do nothing if the string ends with substring that matched the regular expression specified as a string") {
        ...
        "1.78" must endWith regex (".78")
        "1.7" must endWith regex (decimalRegex)
        "21.7" must endWith regex (decimalRegex)
        "1.78" must endWith regex (decimalRegex)
        "x8" must endWith regex (decimalRegex)
        "x1." must endWith regex (decimalRegex)

        // The remaining are full matches, which must also work with "endWith"
        "1.7" must endWith regex ("1.7")
        "1.7" must endWith regex (decimalRegex)
        "-1.8" must endWith regex (decimalRegex)
        "8" must endWith regex (decimalRegex)
        "1." must endWith regex (decimalRegex)
      }
  
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used with not") {

        "eight" must not { endWith regex (decimalRegex) }
        "one.eight" must not { endWith regex (decimalRegex) }
      ...
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used in a logical-and expression") {
        ...
        "b1.7" must (endWith regex (decimalRegex) and (endWith regex (decimalRegex)))
        "b1.7" must ((endWith regex (decimalRegex)) and (endWith regex (decimalRegex)))
        "b1.7" must (endWith regex (decimalRegex) and endWith regex (decimalRegex))

        "1.7" must (endWith regex (decimalRegex) and (endWith regex (decimalRegex)))
        "1.7" must ((endWith regex (decimalRegex)) and (endWith regex (decimalRegex)))
        "1.7" must (endWith regex (decimalRegex) and endWith regex (decimalRegex))
      }
      ...
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used in a logical-or expression") {
        ...
        "b1.7" must (endWith regex ("hello") or (endWith regex (decimalRegex)))
        "b1.7" must ((endWith regex ("hello")) or (endWith regex (decimalRegex)))
        "b1.7" must (endWith regex ("hello") or endWith regex (decimalRegex))
  
        "1.7" must (endWith regex ("hello") or (endWith regex (decimalRegex)))
        "1.7" must ((endWith regex ("hello")) or (endWith regex (decimalRegex)))
        "1.7" must (endWith regex ("hello") or endWith regex (decimalRegex))
      }
  
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used in a logical-and expression with not") {
        "fred" must (not (endWith regex ("bob")) and not (endWith regex (decimalRegex)))
        "fred" must ((not endWith regex ("bob")) and (not endWith regex (decimalRegex)))
        "fred" must (not endWith regex ("bob") and not endWith regex (decimalRegex))
      }
  
      it("must do nothing if the string does not end with a substring that matched the regular expression specified as a string when used in a logical-or expression with not") {
        "fred" must (not (endWith regex ("fred")) or not (endWith regex (decimalRegex)))
        "fred" must ((not endWith regex ("fred")) or (not endWith regex (decimalRegex)))
        "fred" must (not endWith regex ("fred") or not endWith regex (decimalRegex))
      }
      ...
      it("must throw TestFailedException if the string does not match substring that matched the regular expression specified as a string") {
        ...
        val caught3 = intercept[TestFailedException] {
          "-one.eight" must endWith regex (decimalRegex)
        }
        assert(caught3.getMessage === "\"-one.eight\" did not end with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
  
        val caught6 = intercept[TestFailedException] {
          "eight" must endWith regex (decimalRegex)
        }
        assert(caught6.getMessage === "\"eight\" did not end with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
  
        val caught7 = intercept[TestFailedException] {
          "1.eight" must endWith regex (decimalRegex)
        }
        assert(caught7.getMessage === "\"1.eight\" did not end with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
  
        val caught8 = intercept[TestFailedException] {
          "onedoteight" must endWith regex (decimalRegex)
        }
        assert(caught8.getMessage === "\"onedoteight\" did not end with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
  
        val caught9 = intercept[TestFailedException] {
          "***" must endWith regex (decimalRegex)
        }
        assert(caught9.getMessage === "\"***\" did not end with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
      }
      ...
      it("must throw TestFailedException if the string does matches substring that matched the regular expression specified as a string when used with not") {
        ...
        val caught2 = intercept[TestFailedException] {
          "1.7" must not { endWith regex (decimalRegex) }
        }
        assert(caught2.getMessage === "\"1.7\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
  
        val caught3 = intercept[TestFailedException] {
          "-1.8" must not { endWith regex (decimalRegex) }
        }
        assert(caught3.getMessage === "\"-1.8\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
  
        val caught4 = intercept[TestFailedException] {
          "8" must not { endWith regex (decimalRegex) }
        }
        assert(caught4.getMessage === "\"8\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
  
        val caught5 = intercept[TestFailedException] {
          "1." must not { endWith regex (decimalRegex) }
        }
        assert(caught5.getMessage === "\"1.\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
        ...
        val caught22 = intercept[TestFailedException] {
          "b1.7" must not { endWith regex (decimalRegex) }
        }
        assert(caught22.getMessage === "\"b1.7\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
  
        val caught23 = intercept[TestFailedException] {
          "b-1.8" must not { endWith regex (decimalRegex) }
        }
        assert(caught23.getMessage === "\"b-1.8\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
      }
      ...
      it("must throw TestFailedException if the string ends with substring that matched the regular expression specified as a string when used in a logical-and expression") {
        ...
        val caught1 = intercept[TestFailedException] {
          "1.7" must (endWith regex (decimalRegex) and (endWith regex ("1.8")))
        }
        assert(caught1.getMessage === "\"1.7\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?, but \"1.7\" did not end with a substring that matched the regular expression 1.8")
        ...
        // Check to make sure the error message "short circuits" (i.e., just reports the left side's failure)
        val caught4 = intercept[TestFailedException] {
          "1.eight" must (endWith regex (decimalRegex) and (endWith regex ("1.8")))
        }
        assert(caught4.getMessage === "\"1.eight\" did not end with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
      ...
      it("must throw TestFailedException if the string ends with substring that matched the regular expression specified as a string when used in a logical-or expression") {
        ...
        val caught1 = intercept[TestFailedException] {
          "1.seven" must (endWith regex (decimalRegex) or (endWith regex ("1.8")))
        }
        assert(caught1.getMessage === "\"1.seven\" did not end with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?, and \"1.seven\" did not end with a substring that matched the regular expression 1.8")
      ...
      it("must throw TestFailedException if the string ends with substring that matched the regular expression specified as a string when used in a logical-and expression used with not") {
        ...
        val caught1 = intercept[TestFailedException] {
          "1.7" must (not endWith regex ("1.8") and (not endWith regex (decimalRegex)))
        }
        assert(caught1.getMessage === "\"1.7\" did not end with a substring that matched the regular expression 1.8, but \"1.7\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
        ...
        val caught4 = intercept[TestFailedException] {
          "a1.7" must (not endWith regex ("1.8") and (not endWith regex (decimalRegex)))
        }
        assert(caught4.getMessage === "\"a1.7\" did not end with a substring that matched the regular expression 1.8, but \"a1.7\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?")
      ...
      it("must throw TestFailedException if the string ends with substring that matched the regular expression specified as a string when used in a logical-or expression used with not") {
        ...
        val caught1 = intercept[TestFailedException] {
          "1.7" must (not endWith regex (decimalRegex) or (not endWith regex ("1.7")))
        }
        assert(caught1.getMessage === "\"1.7\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?, and \"1.7\" ended with a substring that matched the regular expression 1.7")
        ...
        val caught5 = intercept[TestFailedException] {
          "a1.7" must (not endWith regex (decimalRegex) or (not endWith regex ("1.7")))
        }
        assert(caught5.getMessage === "\"a1.7\" ended with a substring that matched the regular expression (-)?(\\d+)(\\.\\d*)?, and \"a1.7\" ended with a substring that matched the regular expression 1.7")
      }
    }
